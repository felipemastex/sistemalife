...
const DashboardViewComponent = () => {
  ...
  const maxHP = 100; // HP máximo é 100, influenciado pela Constituição mas não é o mesmo.
  const hpPercentage = ((profile.hp_atual || 100) / maxHP) * 100;
                        ...
                        <div>
                         ...
                         <div>
                            <div className="flex justify-between text-sm text-muted-foreground mb-1">
                                ...
                                <span className="font-mono">{profile.hp_atual || 100} / {maxHP} HP</span>
                            </div>
